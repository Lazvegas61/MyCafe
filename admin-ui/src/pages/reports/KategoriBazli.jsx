...
export default function KategoriBazli() {
  ...
  const fetchRapor = async () => {
    try {
      const res = await api.get("/raporlar/kategori-bazli", { params: filtre });
      setRapor(res.data);
    } catch (err) {
  ...
  return (
    <div style={page}>
      {/* ÜST BAR */}
      <div style={topBar}>
        <div style={title}>Kategori Bazlı Satış Raporu</div>
        ...
        <table style={table}>
          <thead>
            <tr>
              ...
              <th style={th}>Toplam Adet</th>
              <th style={th}>Toplam Tutar</th>
            </tr>
          </thead>
